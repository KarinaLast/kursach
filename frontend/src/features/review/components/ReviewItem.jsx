...

          {
            isOwnReview && (
              ...
              <Menu anchorEl={anchorEl} open={open} onClose={handleClose}>
                <MenuItem onClick={()=>{setEdit(true);handleClose()}}>Редактировать</MenuItem>
                <MenuItem onClick={deleteReview}>Удалить</MenuItem>
              </Menu>
            </Stack>
            )
          }
            ...
            edit?(
              <Stack component={'form'} noValidate onSubmit={handleSubmit(handleUpdateReview)} rowGap={2}>
                ...
                <Stack flexDirection={'row'} alignSelf={'flex-end'} columnGap={1} justifyContent={'center'} alignItems={'center'}>
                  <LoadingButton size='small' type='submit' sx={{alignSelf:"flex-end"}} variant='contained'>Обновить</LoadingButton>
                  <Button variant='outlined' size='small' onClick={()=>setEdit(false)} color='error'>Закрыть</Button>
                </Stack>
              </Stack>
