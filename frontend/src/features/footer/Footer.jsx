    ...
    <Stack sx={{backgroundColor:theme.palette.primary.main,paddingTop:"3rem",paddingLeft:is700?"1rem":"3rem",paddingRight:is700?"1rem":"3rem",paddingBottom:"1.5rem",rowGap:"5rem",color:theme.palette.primary.light,justifyContent:"space-around"}}>
            ...
            <Stack flexDirection={'row'} rowGap={'1rem'} justifyContent={is700?"":'space-around'} flexWrap={'wrap'}>
                ...
                <Stack rowGap={'1rem'} padding={'1rem'}>
                    <Typography variant='h6' fontSize={'1.5rem'}>Специальное предложение</Typography>
                    <Typography variant='h6'>Пиши!</Typography>
                    <Typography sx={labelStyles}>И получи скидку в 10% на первый заказ</Typography>
                ...
                <Stack rowGap={'1rem'} padding={'1rem'}>
                    ...
                    <Typography sx={labelStyles}>Витебская область, г.Новополоцк, ул. Молодежная д.1</Typography>
                    <Typography sx={labelStyles}>karia.sidney22@gmail.com</Typography>
                    <Typography sx={labelStyles}>+375(33)444-55-66</Typography>
                </Stack>

                <Stack rowGap={'1rem'} padding={'1rem'}>
                    <Typography  variant='h6'>Аккаунт</Typography>
                    <Typography sx={labelStyles}>Мой аккаунт</Typography>
                    <Typography sx={labelStyles}>Вход / Регистрация</Typography>
                    <Typography sx={labelStyles}>Карточка товара</Typography>
                    <Typography sx={labelStyles}>Избранное</Typography>
                    <Typography sx={labelStyles}>Магазин</Typography>
                </Stack>

                <Stack rowGap={'1rem'} padding={'1rem'}>
                    <Typography  variant='h6'>Быстрые ссылки</Typography>
                    <Typography sx={labelStyles}>Политика конфиденциальности</Typography>
                    <Typography sx={labelStyles}>FAQ</Typography>
                    <Typography sx={labelStyles}>Контакты</Typography>
                </Stack>

                <Stack rowGap={'1rem'} padding={'1rem'}>
                    <Typography  variant='h6'>Скачать приложение</Typography>
                    <Typography sx={{...labelStyles,color:"graytext",fontWeight:500}}>По всем вопросам обращаться:</Typography>
            ...
            <Stack alignSelf={"center"}>
                <Typography color={'GrayText'}>&copy; Book Store {new Date().getFullYear()}. All right reserved</Typography>
            </Stack>
