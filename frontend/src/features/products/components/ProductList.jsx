...
export const ProductList = () => {
    ...
    useEffect(()=>{
        if(productFetchStatus==='rejected'){
            toast.error("Ошибка при выборе продуктов, пожалуйста, повторите попытку позже")
        }
    },[productFetchStatus])
        ...
        <Stack mb={'3rem'}>
                ...
                <Stack rowGap={5} mt={is600?2:0}>
                    ...
                    <Stack alignSelf={is488?'center':'flex-end'} mr={is488?0:5} rowGap={2} p={is488?1:0}>
                        ...
                        <Typography textAlign={'center'}>Показать {(page-1)*ITEMS_PER_PAGE+1} с {page*ITEMS_PER_PAGE>totalResults?totalResults:page*ITEMS_PER_PAGE} по {totalResults} результаты</Typography>
                    </Stack>    
