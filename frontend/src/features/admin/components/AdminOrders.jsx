...
export const AdminOrders = () => {
  ...
  const editOptions=['В обработке','Отправлен','Готов к доставке','Доставлен','Отмененный']
...

        {
            ...
            <Table aria-label="simple table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="right">Полная стоимость</TableCell>
                  <TableCell align="right">Адрес доставки</TableCell>
                  <TableCell align="right">Метод оплаты</TableCell>
                  ...
                  <TableRow key={order._id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                    ...
                    <TableCell align="right">
                        ...
                        <FormControl fullWidth>
                          <InputLabel id="demo-simple-select-label">Обновить статус</InputLabel>
                          <Select
          ...
          <Stack width={is480?"auto":'30rem'} justifyContent={'center'}>
            ...
            <Stack rowGap={'1rem'}>
                ...
                <Typography textAlign={'center'} alignSelf={'center'} variant='h6' fontWeight={400}>Здесь нет заказов</Typography>
            </Stack>
